        ...
        conceptos.forEach(concepto => {
            if (concepto.fixedDate && concepto.value) {
                patrones.push({
                    ...
                    confianza: 1.0, // Confianza total porque es explícito
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
            ...
            <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                ...
                // Busca esta sección (aproximadamente línea 250-270):
                {/* Gráfico de Proyección */}
                {predicciones.length > 0 && (
                    <>
                        <div className="bg-white shadow rounded-lg p-6 mb-6">
                            <h3 className="text-subtitle text-lg mb-4">Proyección Financiera</h3>
                            <div className="h-96 w-full"> {/* ← Cambia esto: altura fija de 96 (384px) y ancho completo */}
                                <ResponsiveContainer width="100%" height="100%">
                                    <AreaChart data={predicciones} margin={{ top: 20, right: 30, left: 80, bottom: 20 }}>
                                        <CartesianGrid strokeDasharray="3 3" />
                                        <XAxis dataKey="fecha" tick={{ fill: '#374151' }} />
                                        <YAxis
