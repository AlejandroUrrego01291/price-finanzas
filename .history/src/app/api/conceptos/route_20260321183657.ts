...
export async function POST(request: Request) {
    try {
        ...
        const { type, name, category, subType, value, fixedDate } = await request.json()
...
export async function PUT(request: Request) {
    try {
        ...
        const { id, type, name, category, subType, value, fixedDate } = await request.json()
        ...
        // 🔥 NUEVO: Actualizar todas las transacciones asociadas con este concepto
        ...
        console.error('Error en PUT concepto:', error)
        return NextResponse.json(
