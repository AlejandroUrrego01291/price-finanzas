...
export async function GET() {
    try {
        ...
        console.error('Error en GET conceptos:', error)
...
export async function POST(request: Request) {
    try {
        ...
        console.error('Error en POST conceptos:', error)
        return NextResponse.json(
...
export async function PUT(request: Request) {
    try {
        ...
        console.error('Error en PUT conceptos:', error)
        return NextResponse.json(
...
export async function DELETE(request: Request) {
    try {
        ...
        console.error('Error en DELETE conceptos:', error)
        return NextResponse.json(
