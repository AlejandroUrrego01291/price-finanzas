        ...
        <div className="min-h-screen bg-gray-50">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                        <div className="flex items-center">
                            <h1 className="text-xl font-semibold text-gray-900">Price - Administración de Ahorros</h1>
                        </div>
            ...
            <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                ...
                <div className="mb-6 flex justify-between items-center">
                    <h2 className="text-2xl font-bold text-gray-900">Mis Metas de Ahorro</h2>
                    <button
                                    ...
                                    <div className="flex justify-between items-start">
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600">
                                                Fecha de inicio: {formatearFecha(ahorro.startDate)}
                                            </p>
                                        </div>
                                                ...
                                                <tbody className="bg-white divide-y divide-gray-200">
                                                    {ahorro.contributions.map((contribucion) => (
                                                        <tr key={contribucion.id} className="hover:bg-gray-50">
                                                            <td className="px-6 py-2 whitespace-nowrap text-sm">{formatearFecha(contribucion.date)}</td>
                                                            <td className="px-6 py-2 whitespace-nowrap text-sm">{formatearMoneda(contribucion.amount)}</td>
                                                            <td className="px-6 py-2 whitespace-nowrap text-sm">{contribucion.extraAmount ? formatearMoneda(contribucion.extraAmount) : '-'}</td>
                                                            <td className="px-6 py-2 whitespace-nowrap text-sm font-medium">{formatearMoneda(contribucion.totalSaved)}</td>
                                                        </tr>
                                                    ))}
                                                </tbody>
                                            </table>
