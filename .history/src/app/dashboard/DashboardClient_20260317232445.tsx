                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                        <div className="flex items-center">
                            <h1 className="text-title text-xl bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent font-bold">
                                Price
                            </h1>
                        </div>

                        {/* Navegación principal - Moderna y centrada */}
                        <div className="flex items-center space-x-1">
                            <Link
                                href="/transacciones"
                                className="px-4 py-2 text-body font-medium rounded-lg hover:bg-blue-50 hover:text-blue-600 transition-all duration-200 ease-in-out transform hover:scale-105"
                            >
                            ...
                            <Link
                                href="/conceptos"
                                className="px-4 py-2 text-body font-medium rounded-lg hover:bg-green-50 hover:text-green-600 transition-all duration-200 ease-in-out transform hover:scale-105"
                            >
                                <span className="flex items-center space-x-1">
                                    <span>📁</span>
                                    <span>Conceptos</span>
                            ...
                            <Link
                                href="/deudas"
                                className="px-4 py-2 text-body font-medium rounded-lg hover:bg-red-50 hover:text-red-600 transition-all duration-200 ease-in-out transform hover:scale-105"
                            >
                                <span className="flex items-center space-x-1">
                                    <span>💳</span>
                                    <span>Deudas</span>
                            ...
                            <Link
                                href="/ahorros"
                                className="px-4 py-2 text-body font-medium rounded-lg hover:bg-yellow-50 hover:text-yellow-600 transition-all duration-200 ease-in-out transform hover:scale-105"
                            >
                                <span className="flex items-center space-x-1">
                                    <span>🐷</span>
                                    <span>Ahorros</span>
                            ...
                            <Link
                                href="/predicciones"
                                className="px-4 py-2 text-body font-medium rounded-lg hover:bg-purple-50 hover:text-purple-600 transition-all duration-200 ease-in-out transform hover:scale-105"
                            >
                                <span className="flex items-center space-x-1">
                                    <span>🔮</span>
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <Link
                                ...
                                className="px-4 py-2 text-sm font-medium text-red-600 hover:text-white border border-red-600 rounded-lg hover:bg-red-600 transition-all duration-200 ease-in-out transform hover:scale-105"
                            >
                                Cerrar sesión
                            </Link>
                        </div>
