                    ...
                    <div className="border-4 border-dashed border-gray-200 rounded-lg p-8">
                        ...
                        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <Link href="/transacciones"
                                ...
                                <p className="text-gray-600">Registra tus ingresos y gastos diarios</p>
                            </Link>

                            <Link href="/deudas"
                                className="block p-6 bg-white rounded-lg border border-gray-200 hover:shadow-lg transition">
                                <h3 className="text-lg font-semibold text-gray-900 mb-2">💳 Administrar Deudas</h3>
                                <p className="text-gray-600">Controla tus deudas y pagos mensuales</p>
                            </Link>
                        </div>
                    </div>
                </div>
