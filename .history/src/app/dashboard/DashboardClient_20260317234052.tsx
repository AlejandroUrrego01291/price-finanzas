        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-20 items-center">
                        ...
                        <div className="flex items-center space-x-4">
                            <div className="hidden md:flex items-center space-x-3 px-4 py-2 bg-gradient-to-r from-gray-100 to-gray-200 rounded-full shadow-inner">
                                <span className="text-sm text-gray-700 font-medium">Demo User</span>
                                <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white text-sm font-bold shadow-md">
                                    U
                                </div>
                            </div>
            ...
            <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-transform duration-300">
                    ...
                    <div className="bg-gradient-to-br from-red-500 to-red-600 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-transform duration-300">
                    ...
                    <div className={`bg-gradient-to-br ${totales.balance >= 0 ? 'from-blue-500 to-blue-600' : 'from-orange-500 to-orange-600'} rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-transform duration-300`}>
