...
export default async function DashboardPage() {
    ...
    // Convertir fechas de Date a string - INCLUIR EL CAMPO completed
    const transacciones = transaccionesDB.map(t => ({
        ...
        category: t.category,
        subType: t.subType,
        completed: t.completed,  // ← NUEVO: incluir el campo completed
        userId: t.userId,
            ...
            <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
                ...
                <main className="max-w-7xl mx-auto py-12 px-4">
                    <div className="bg-white shadow rounded-lg p-12 text-center">
                        <h2 className="text-2xl font-bold text-gray-900 mb-4">Bienvenido a Mis Finanzas</h2>
